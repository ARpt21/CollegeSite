...
var firebaseConfig = {
  ...
  function register () {
    ...
    unique_identification = document.getElementById('unique_identification').value
    ...
    if (validate_field(full_name) == false || validate_field(unique_identification) == false || validate_field(staff) == false) {
